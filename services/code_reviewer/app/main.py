...
async def lifespan(app: FastAPI):
    ...
    logger.info("Code Reviewer Agent is starting up.")
    subscriber_task = asyncio.create_task(async_redis_subscriber())
    yield
    logger.info("Code Reviewer Agent is shutting down.")
...
async def async_redis_subscriber():
    """Listens for tasks on the 'code_reviewer_tasks' channel."""
    ...
    while True:
        try:
            ...
            await process_review_task(task_data, redis_client)
