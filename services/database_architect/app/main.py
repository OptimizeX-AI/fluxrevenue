...
AGENT_VERSION = "1.0.0"
AGENT_CAPABILITIES = ["database_schema_design", "sql_generation", "orm_mapping"]
AGENT_SUPPORTED_LANGUAGES = ["sql"]
...
def task_consumer_callback(message: dict):
    ...
    try:
        ...
        asyncio.run(process_schema_task(task_data, None)) # Passing None for redis_client
