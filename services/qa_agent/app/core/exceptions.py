class BaseAgentException(Exception):
    """Base exception for all custom exceptions in the QA Agent."""
    def __init__(self, message="An error occurred in the QA Agent."):
...
class TestGenerationError(BaseAgentException):
    """Raised when an error occurs during test generation."""
