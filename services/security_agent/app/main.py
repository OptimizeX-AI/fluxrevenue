...
AGENT_VERSION = "1.0.0"
AGENT_CAPABILITIES = ["vulnerability_scanning", "dependency_checking", "static_application_security_testing"]
...
def task_consumer_callback(message: dict):
    ...
    try:
        ...
        asyncio.run(process_security_task(task_data, None)) # Passing None for redis_client
