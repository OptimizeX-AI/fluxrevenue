...
module.exports = function override(config, env) {
  ...
  config.resolve.alias = {
    ...
    '@/types': path.resolve(__dirname, 'src/types') // ✅ ADICIONADO
  };

  // ✅ Fallbacks para Node.js modules (para Supabase)
  ...
  // ✅ ProvidePlugin para Buffer global
  config.plugins.push(
  ...
  if (env === 'production') {
    ...
    // ✅ CORREÇÃO: splitChunks com sintaxe correta
    config.optimization.splitChunks = {
      ...
      } // ✅ CORREÇÃO: Fechar cacheGroups corretamente
    };
