...
const Optimizer: React.FC = () => {
  ...
  const initializeProcessingSteps = useCallback(() => { /* ... */ return [ { id: 'analysis', title: 'Analisando Site', description: 'Analisando dados do site', status: 'processing', progress: 0 }, { id: 'optimization', title: 'Aplicando Otimizações', description: 'Aplicando otimizações selecionadas', status: 'pending', progress: 0 }, { id: 'script', title: 'Gerando Script', description: 'Gerando script de otimização', status: 'pending', progress: 0 }, { id: 'validation', title: 'Validação Final', description: 'Validando configurações', status: 'pending', progress: 0 } ]; }, []);
